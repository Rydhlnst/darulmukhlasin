          ...
          {stats.map((stat, index) => {
            ...
            return (
              <Reveal key={stat.label} delay={index * 100}>
                <Card className="h-full border-[#d5ecd5] bg-[#eef7ee] text-center shadow-sm">
                  <CardContent>
                    <div className="mb-3 inline-flex h-14 w-14 items-center justify-center rounded-full bg-[#1a5c2a] text-white">
