        ...
        <Card className="overflow-hidden border-0 bg-foreground text-background shadow-xl">
          <CardContent className="relative px-6 py-12 text-center lg:px-12 lg:py-20">
            ...
            <div className="relative">
              <h2 className="mb-4 text-2xl font-bold tracking-tight text-background sm:text-3xl lg:text-4xl">
                Siap bergabung bersama kami?
              </h2>
              <p className="mx-auto mb-8 max-w-2xl text-background/70">
                Tim kami siap membantu proses pendaftaran dan konsultasi
                pendidikan putra-putri Anda. Bergabunglah dalam membentuk
                generasi Qur&apos;ani yang beriman, berilmu, dan beramal.
              </p>
