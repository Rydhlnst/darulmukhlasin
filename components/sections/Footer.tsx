    ...
    <footer className="border-t border-border bg-foreground text-background">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          <div className="sm:col-span-2 lg:col-span-1">
            <div className="flex items-center gap-3">
              <Image
                ...
                width={40}
                height={40}
                className="h-10 w-10 shrink-0 rounded-full object-cover ring-2 ring-background/20"
              />
              <div>
            ...
            <div className="mt-4 flex items-center gap-2">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="flex h-8 w-8 items-center justify-center rounded-full text-background/60 transition-colors hover:bg-background/10 hover:text-background"
          ...
          <div>
            <h4 className="mb-4 text-xs font-semibold uppercase tracking-wider text-background/80">
              Navigasi
            </h4>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {programLinks.map((program) => (
                <li key={program}>
                  <span className="text-xs text-background/60">{program}</span>
                </li>
              ))}
            </ul>
          </div>
