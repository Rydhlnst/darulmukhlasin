            ...
            return (
              <Card key={item.title} className="group border-[#d5ecd5] bg-[#eef7ee] shadow-sm transition-shadow hover:shadow-md">
                <CardContent className="flex flex-col items-center text-center">
                  <div className="mb-3 flex h-12 w-12 items-center justify-center rounded-full bg-[#fef3c7] text-[#b45309] transition-colors group-hover:bg-[#1a5c2a] group-hover:text-white">
