...
const tokohItems = [
  {
    ...
    description: "Pendidik dan pengasuh pesantren yang berasal dari Madura.",
  },
  {
    name: "Almarhum H. Ismail Puteh",
    role: "Tokoh Masyarakat",
    description: "Sal satu tokoh masyarakat yang ikut membidani berdirinya pesantren.",
  },
  {
    name: "H. Makmun Santoso, S.Pd.",
    role: "Tokoh Masyarakat",
    description: "Tokoh masyarakat yang mendukung pendirian pesantren.",
  },
  {
    name: "Bapak Sutarto",
    role: "Tokoh Masyarakat",
    description: "Tokoh masyarakat yang turut serta dalam musyawarah pendirian.",
  },
];
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto max-w-2xl text-muted-foreground">
            Sejarah singkat perjalanan Pondok Pesantren Tahfidzul Qur&apos;an Darul
            Mukhlasin KUBA dari awal berdiri hingga saat ini.
          </p>
        </div>
        ...
        <Card className="mt-8">
          <CardContent className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm leading-relaxed text-muted-foreground">
                Dengan semangat pengabdian yang terus dijaga, Pondok Pesantren
                Tahfidzul Qur&apos;an Darul Mukhlasin KUBA berkomitmen untuk terus
                mencetak generasi Qur&apos;ani yang beriman, berilmu, dan beramal,
                serta menjadi pusat pendidikan Islam yang memberikan manfaat
