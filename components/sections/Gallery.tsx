    ...
    <section id="galeri" className={compact ? "py-16 lg:py-24" : "min-h-screen py-16 lg:py-24"}>
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                >
                  ...
                  >
                    ...
                    <button
                      ...
                      className="absolute top-2 right-2 flex h-9 w-9 items-center justify-center rounded-full bg-secondary text-foreground transition-colors hover:bg-muted"
                      aria-label="Tutup"
                    >
        ...
        <div className="mt-6 flex justify-center gap-2">
          {Array.from({ length: Math.min(slidesToShow, 19) }).map((_, index) => (
            <button
              key={index}
        ...
        {compact && (
          <div className="mt-8 text-center">
            <Button variant="outline" render={<Link href="/galeri" />}>
